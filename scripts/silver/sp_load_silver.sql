...
BEGIN
	...
	SELECT 
		...
		SUBSTRING(prd_key, 7, LEN(prd_key)) AS prd_key, --Exract product key
		prd_nm,
	...
	*,
	...
	SET @start_time = GETDATE();
	PRINT '>> TRUNCATING AND INSERTING INTO: silver.crm_sales_details';
	...
	SET @start_time = GETDATE();
	PRINT '>> TRUNCATING AND INSERTING INTO: silver.erp_cust_az12';
